...
import type { Incident, PredictionModel } from "@/lib/aiops/types"
          ...
          <div className="flex items-center justify-between">
            <div className="max-w-3xl">
              ...
              <p className="mb-6 text-xl text-muted-foreground">
                ML-Powered AIOps Platform with Predictive Monitoring & Automated Remediation
              </p>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  Advanced ML algorithms detect anomalies using Z-score analysis with adaptive thresholds and time
                  series forecasting.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  Intelligent log parsing and pattern recognition to identify issues, cluster errors, and extract
                  actionable insights.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  Self-healing infrastructure with automated remediation actions for common issues, reducing MTTR by
                  80%.
                </p>
              </CardContent>
            </Card>
