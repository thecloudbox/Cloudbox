        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-4">
              <LogoOption1 />
              <span className="text-sm text-terminal-green/50 font-mono">© 2026 | exit status 0</span>
            </div>
            <div className="flex gap-2">
              {[1, 2, 3, 4, 5].map((num) => (
                <Link key={num} href={`/${num}`}>
                  <Button
                    variant={num === 2 ? "default" : "ghost"}
                    size="sm"
                    className={
                      num === 2
                        ? "bg-terminal-green hover:bg-terminal-yellow text-black font-mono"
                        : "text-terminal-green/50 hover:text-terminal-green font-mono"
                    }
                  >
                    {num}
                  </Button>
